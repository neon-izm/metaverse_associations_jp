...
### 曖昧さ回避
このリストは「**メタバースに係る団体**」をまとめたものです。「**名称に"メタバース"が含まれる団体**」についてはフォーク元プロジェクトの[こちら](https://github.com/neon-izm/metaverse_associations_jp)をご覧ください。**メタバースに係る団体**の基準は、検証可能な信頼できる情報源による言及です。
